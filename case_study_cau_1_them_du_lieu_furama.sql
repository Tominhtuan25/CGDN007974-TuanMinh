...
values
     ...
     ('Room');
-- 7.Nhân Viên.
insert into nhan_vien (ho_ten_nhan_vien, ngay_sinh, so_cmnd, luong, so_dien_thoai, email, dia_chi, ma_vi_tri, ma_trinh_do, ma_bo_phan)
values
     ...
     ('Nguyễn Bỉnh Phát', '1999-12-09', '454363232', 6000000, '0902341231', 'phatphong@gmail.com', '43 Yên Bái, Đà Nẵng', 2, 1, 1),
     ...
     -- 8.Khách Hàng.
insert into khach_hang (ho_ten_khach_hang, ngay_sinh, gioi_tinh, so_cmnd, so_dien_thoai, email, dia_chi, ma_loai_khach)
values
