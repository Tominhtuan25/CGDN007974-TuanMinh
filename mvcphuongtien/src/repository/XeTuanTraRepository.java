...
public class XeTuanTraRepository implements IXeTuanTraRepository {
    private final String XE_TUAN_TRA_MAT_TRANG_FILE = "data/XeTuanTraMatTrang.csv";
    @Override
    public List<XeTuanTraMatTrang> findAll() {
        List<XeTuanTraMatTrang> xeTuanTraMatTrangList = new ArrayList<>();
        List<String> stringList = ReadAndWriteFile.readFileCSVToStringList(XE_TUAN_TRA_MAT_TRANG_FILE);
        String[] array = null;
    ...
    public void add(XeTuanTraMatTrang xeTuanTraMatTrang) {
        ...
        ReadAndWriteFile.writeStringListToCSV(XE_TUAN_TRA_MAT_TRANG_FILE, stringList,true);
